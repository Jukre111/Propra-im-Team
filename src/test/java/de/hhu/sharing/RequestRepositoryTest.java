...
public class RequestRepositoryTest {
    ...
    public ArrayList<Request> createRequests(){
        ...
        Request request1 = new Request(startdate,enddate,requester1 );
        Request request2 = new Request(startdate,enddate,requester2 );
        Request request3 = new Request(startdate,enddate,requester1 );
